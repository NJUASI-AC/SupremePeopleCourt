...
public class RecommendServiceImpl implements RecommendService {
    ...
    private List<RecommendCase> getDates() {
        ...
        caseID = new CaseID("（2010）南民初字第4871号", DocumentName.CIVIL_WRITTENVERFICT);
        ...
        recommendCases.add(new RecommendCase(caseID, DocumentName.CIVIL_WRITTENVERFICT, record, actionCause, evidence, facts, refereeAnalysisProcess));

        caseID = new CaseID("（2010）南民初字第4871-1号", DocumentName.CIVIL_WRITTENVERFICT);
        evidence = new ArrayList<>();
        evidence.add("");
        facts = new ArrayList<>();
        legalArticles = new ArrayList<>();
        ...
        caseID = new CaseID("(2003)东民初字第1179号", DocumentName.CIVIL_WRITTENVERFICT);
        evidence = new ArrayList<>();
        evidence.add("");
        facts = new ArrayList<>();
        fact = "";
        ...
        recommendCases.add(new RecommendCase(caseID, DocumentName.CIVIL_JUDGMENT, record, actionCause, evidence, facts, refereeAnalysisProcess));

        caseID = new CaseID("(2016)津0115民初6408号", DocumentName.CIVIL_WRITTENVERFICT);
        evidence = new ArrayList<>();
        evidence.add("");
        facts = new ArrayList<>();
        ...
        caseID = new CaseID("（2007）蓟民初字第2267号", DocumentName.CIVIL_WRITTENVERFICT);
        evidence = new ArrayList<>();
        evidence.add("");
        facts = new ArrayList<>();
