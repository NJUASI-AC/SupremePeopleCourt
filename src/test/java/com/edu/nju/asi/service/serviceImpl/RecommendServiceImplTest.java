...
public class RecommendServiceImplTest {
    ...
    public void testRecommend() throws Exception {
        ...
        myCase = new RecommendCase("（2008）南民初字第5793号", DocumentName.CIVIL_JUDGMENT, "原告曲晓英与被告黄东撤销婚姻纠纷一案，本院受理后，依法由审判员董巧云独任审判，公开开庭进行了审理。原告曲晓英及其委托代理人杨玉立，被告黄东到庭参加诉讼。本案现已审理终结。", "撤销婚姻纠纷", evidence, facts, refereeAnalysisProcess);
